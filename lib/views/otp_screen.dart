              ...
              child: Column(
                children: [
                 ...
                 Padding(
                  ...
                  Center(child: Text("Verification Code",style: TextStyle(fontSize: 20),)),
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Center(child: Text("Please enter the verification code sent to mobile ",style: TextStyle(fontSize: 16),)),
                  ),
                    PinCodeFields(
                              length: 4,
